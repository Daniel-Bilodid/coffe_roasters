<template>
  <div class="ml-[165px]">
    <div class="flex mt-[80px]">
      ...
      <div class="w-[349px] h-[2px] border-2 border-customPink mt-[12px]"></div>
    ...
    <div class="flex gap-[95px]">
      <div>
        ...
        <p
          class="w-[255px] h-[73px] text-[32px] font-fraunces font-black text-black text-left mt-[35px]"
        >
          Pick your coffee
        </p>
        <p
          class="w-[285px] h-[130px] font-barlow text-[16px] text-left mt-[42px] text-customBlack"
        >
